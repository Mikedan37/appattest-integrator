...
**For formal mathematical treatment, see [Formal Control Model Appendix](/docs/CONTROL_FORMALISM.md).**
...
**For control-theoretic formalization with equations and proofs, see [CONTROL_FORMALISM.md](/docs/CONTROL_FORMALISM.md).**
